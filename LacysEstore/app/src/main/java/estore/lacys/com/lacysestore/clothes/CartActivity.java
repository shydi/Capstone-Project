...
public class CartActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //These lines of code leads to a cart but
        //Because the cart instantiates onCreate (every time it starts), it will double some of the
        //same inventory
        //This leads to double items in the cart only for the women's and children's codes
